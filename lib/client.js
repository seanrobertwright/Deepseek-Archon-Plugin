      ...
      React.useEffect(function () {
        ...
        Promise.all([
          ...
          patch({
            ...
            artifacts: !listing.__error && Array.isArray(listing.files) ? listing.files : null,
            artifactsError: listing.__error ? "Artifacts unavailable: " + errorText(listing.__error) : "",
          });
        });
