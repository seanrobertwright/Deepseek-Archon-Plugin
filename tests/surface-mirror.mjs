...
import { embeddedSurface, splitClient, CLIENT_PATH, START, END } from '../scripts/sync-client-surface.mjs'
...
// still split into the same block, so a `core.autocrlf=true` checkout cannot
